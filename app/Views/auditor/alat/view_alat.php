    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Alat Auditor</li>
        </ol>
      </nav>
            ...
            <?php if (!empty($dataMb)): ?>
              ...
              <?php foreach ($dataMb as $a): ?>
                <tr>
                  ...
                  <td>
                    <p class="text-xs text-secondary mb-0"><?= $a['id_alat'] ?></p>
                  </td>
                  <td>
                    <p class="text-xs text-secondary mb-0"><?= $a['nama_alat'] ?></p>
                  </td>
                  <td>
                  ...
                  <td class="align-middle">
                    <button type="button" class="btn btn-sm btn-warning btnEdit" data-bs-toggle="modal"
                      data-bs-target="#modalEdit" data-id="<?= $a['id_alat'] ?>" data-kode="<?= $a['kode_alat'] ?>"
                      data-nama="<?= $a['nama_alat'] ?>" data-spesifikasi="<?= $a['spesifikasi'] ?>"
                      data-disiapkan="<?= $a['disiapkan_oleh'] ?>" data-fungsi="<?= $a['fungsi'] ?>">
                      Edit
                    </button>

                    <a href="<?= base_url('auditor/alat/delete_alat/' . $a['id_alat']) ?>" class="btn btn-sm btn-danger"

            ...
            <?php if (!empty($dataMb)): ?>
              ...
              <?php foreach ($dataMb as $a): ?>
                <tr>
                  ...
                  <td>
                    <p class="text-xs font-weight-bold mb-0"><?= $a['kode_aset'] ?></p>
                  </td>
                  <td>
                    <p class="text-xs font-weight-bold mb-0"><?= $a['nama_aset'] ?></p>
                  </td>
                  <td>
                    <p class="text-xs font-weight-bold mb-0"><?= $a['jenis'] ?></p>
                  </td>
                  ...
                  <td class="align-middle">
                    ...
                    <a href="<?= base_url('auditor/hapus_dokumen/' . $a['id_aset']) ?>" class="btn btn-sm btn-danger"

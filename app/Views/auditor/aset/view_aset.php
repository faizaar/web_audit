      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Aset</li>
          </ol>
        </nav>
            ...
            <?php if (!empty($dataMb)): ?>
              ...
              <?php foreach ($dataMb as $a): ?>
                <tr>
                  ...
                  <td>
                    <p class="text-xs text-secondary mb-0"><?= $a['kode_aset'] ?></p>
                  </td>
                  <td>
                    <p class="text-xs text-secondary mb-0"><?= $a['nama_aset'] ?></p>
                  </td>
                  <td>
                  ...
                  <td>
                    <p class="text-xs text-secondary mb-0"><?= $a['kategori'] ?></p>
                  </td>
                  <!-- <td class="align-middle">
                    <a href="<?= base_url('auditor/edit_dokumen/' . $a['id_aset']) ?>"
                      class="btn btn-sm btn-warning">Edit</a>
                    <a href="<?= base_url('auditor/aset/hapus/' . $a['id_aset']) ?>" class="btn btn-sm btn-danger"

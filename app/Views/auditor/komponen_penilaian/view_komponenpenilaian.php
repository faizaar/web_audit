            ...
            <?php if (!empty($dataMb)): ?>
              ...
              <?php foreach ($dataMb as $a): ?>
                <tr>
                  ...
                  <td>
                    <p class="text-xs font-weight-bold mb-0"><?= $a['id_kontrol'] ?></p>
                  </td>
                  <td>
                    <p class="text-xs font-weight-bold mb-0"><?= $a['domain'] ?></p>
                  </td>
                  <td>
                    <p class="text-xs font-weight-bold mb-0"><?= $a['tahapan'] ?></p>
                  </td>
                  <td>
                    <p class="text-xs font-weight-bold mb-0"><?= $a['aktivitas'] ?></p>
                  </td>

...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Komponen Penilaian</li>
          </ol>
        </nav>
  ...
  <div class="card m-3">
    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
      <h6>Data Audit</h6>
      <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambah">Tambah Data</button>
    </div>
            ...
            <?php if (!empty($dataMb)): ?>
              ...
              <?php foreach ($dataMb as $a): ?>
                <tr>
                  ...
                  <td>
                    <p class="text-xs text-secondary mb-0"><?= $a['id_kontrol'] ?></p>
                  </td>
                  <td>
                    <p class="text-xs text-secondary mb-0"><?= $a['domain'] ?></p>
                  </td>
                  <td>
                    <p class="text-xs text-secondary mb-0"><?= $a['tahapan'] ?></p>
                  </td>
                  <td>
                    <p class="text-xs text-secondary mb-0"><?= $a['aktivitas'] ?></p>
                  </td>
